...
if __name__ == '__main__':
    # 定义参数
    trainingFile = "data/cmj_training.txt"  #  training data
    developFile = "data/cmj_develop.txt"    #  devewlop data
    testingFile = "data/cmj_testing.txt"    #  testing  data
    resultFile = "predictRst.score"         #  predict score
